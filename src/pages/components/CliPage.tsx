  ...
  return (
    <div className="flex flex-col gap-10 pb-20 animate-fadeIn max-w-3xl">
      ...
      <div className="neo-box bg-white dark:bg-zinc-800 p-6 border-[3px] border-black dark:border-white shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">
        ...
        <CodeBlock code="npx easeui --help" language="bash" showLineNumbers={false} variant="light" />
      </div>
      ...
      <div>
        ...
        <CodeBlock code="npx easeui init" language="bash" showLineNumbers={false} variant="light" />
      </div>
      ...
      <div>
        ...
        <CodeBlock code="npx easeui add button" language="bash" showLineNumbers={false} variant="light" />
