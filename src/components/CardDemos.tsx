    ...
    <div className="mx-auto grid w-full max-w-sm gap-4">
      ...
      <Card className={selectedSpacing?.className}>
        <CardHeader>
          ...
          <CardAction>
            <ShadcnButton variant="link">Sign Up</ShadcnButton>
          </CardAction>
        </CardHeader>
        <CardContent>
          <form>
        ...
        type="single" className="w-full"> Login with Google </ShadcnButton>
        </CardFooter>
      </Card>
    </div>
  )
...
export function CardSmall() {
  ...
  return (
    <Card size="sm" className="mx-auto w-full max-w-xs">
      ...
      <CardFooter className="flex-col gap-2">
        <ShadcnButton size="sm" className="w-full">
          Set up scheduled reports
        </ShadcnButton>
        <ShadcnButton variant="outline" size="sm" className="w-full">
          See what&apos;s new
        </ShadcnButton>
      </CardFooter>
    </Card>
...
export function RealEstatePropertyListingGrid() {
    const cards = [
...
export function UserProfileCardFull() {
...
export function OnHoverTiltEffectCard() {
...
export function UserProfileCardRounded() {
...
export function BlogCardComponents() {
    return (
...
export function BlogCardWithHoverEffect() {
...
export function NotifyCardWithGlassEffect() {
...
export function SimpleCardWithButtom() {
...
export function ProductCardsWithDiscount() {
...
export function GradientBoarderHoverCard() {
